# Arithmetic Pupil’s Book Standard One — ADT Bundle Reference
...
**Arithmetic Pupil’s Book Standard One** — This book is a Standard One arithmetic pupil’s book from Tanzania, published by the Tanzania Institute of Education in English for early primary learners, roughly first-grade level. It introduces foundational math skills through simple, activity-based lessons on counting, reading and writing numbers, comparing quantities, addition and subtraction up to 99, place value with ones and tens, Tanzanian money, basic word problems, and simple plane figures. The text reflects a highly structured, practice-oriented teaching approach with many exercises, visual examples, and some use of ICT tools to help children build basic numeracy step by step.
...
├── ARITHMETIC-STD-1-PB--SEPT-2025-.db                    # SQLite database (pipeline state)
├── ARITHMETIC-STD-1-PB--SEPT-2025-.pdf                   # Original source PDF
...
```json
{
  ...
  "pg001_im001": "",
  "gl001": "abacus",
  "gl001_def": "a tool with beads used to show numbers and help with counting or math",
  "qz001_que": "Which word tells about a group with a small number of objects?",
  "qz001_o0": "1) many",
  "qz001_o0_exp": "❌ Not quite. 'Many' means a large number of objects, not a small number."
}
```
...
```json
{
  "abacus": {
    "word": "abacus",
    "definition": "a tool with beads used to show numbers and help with counting or math",
    "variations": ["abacus","abacuses"],
    "emoji": "🧮"
  }
}
```
...
```json
{
  "title": "Arithmetic Pupil’s Book Standard One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-US"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Which word tells about a group with a small number of objects?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. 'Many' means a large number of objects, not a small number." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) many</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `ARITHMETIC-STD-1-PB--SEPT-2025-.pdf` |
| Pipeline database | `ARITHMETIC-STD-1-PB--SEPT-2025-.db` (SQLite) |
